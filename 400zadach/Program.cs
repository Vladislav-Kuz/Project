...
namespace Serg40in {
  class Program {
    ...
    Console.WriteLine("Площадь круга = " + square + " см. кв.");
    Console.ReadKey(); 
  } 
 }
}
...
Дано три числа. Найдите самое большее число, самое маленькое число и сумму максимального и минимального числа. Для решения использовать только методы класса Math.
...
Дано одно натуральное четырехзначное число. Найдите самое большое число, полученное из заданного циклической перестановкой его цифр.
